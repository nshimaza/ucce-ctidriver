...
data FloatElem
    ...
    | ConnectedPartyDevIDType   (SafeEnum (CtiOpt DeviceIDType))                 -- 40
    ...
    | CallConnDevIDType         (SafeEnum (CtiOpt ConnectionDeviceIDType))       -- 57
    | CallConnDevID             String64                                         -- 58
    | CallDevIDType             (SafeEnum (CtiOpt DeviceIDType))                 -- 59
    ...
    | SkillGroupPriorityF       SkillGroupPriority                               -- 64
    ...
    | NextAgentState            (SafeEnum AgentState)                            -- 123
...
getF 64 = return . SkillGroupPriorityF . decode
...
putF (SkillGroupPriorityF x) = putFloatElem 64 x
